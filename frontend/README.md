...
- For live auth testing, run the API server:
  ...
  - use `http://127.0.0.1:8080/signin.html` or `http://127.0.0.1:8080/up.html`
...
- Use `http://127.0.0.1:8080/signin.html` and `http://127.0.0.1:8080/up.html` for login/session testing.
