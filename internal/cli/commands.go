...
func printAPIUsage() {
	...
	fmt.Println("  BASELINE_API_KEY=(set one admin/service key) or BASELINE_API_KEYS=(comma-separated key:role mappings)")
	fmt.Println("  BASELINE_API_REQUIRE_HTTPS=false")
	fmt.Println("  BASELINE_API_SELF_SERVICE_ENABLED=true")
	fmt.Println("  BASELINE_API_ENROLLMENT_TOKENS=(comma-separated enrollment mappings)")
	...
	fmt.Println("  BASELINE_API_GITHUB_WEBHOOK_SECRET=(set webhook secret value)")
	fmt.Println("  BASELINE_API_GITLAB_WEBHOOK_TOKEN=(set webhook token value)")
	fmt.Println("  BASELINE_API_GITHUB_TOKEN=(set GitHub access token)")
	fmt.Println("  BASELINE_API_GITHUB_API_URL=https://api.github.com")
	fmt.Println("  BASELINE_API_GITLAB_TOKEN=(set GitLab access token)")
